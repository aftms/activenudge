...
class ActivitySeedService {
    ...
    return <Activity>[
      ...
      Activity(
        ...
        translations: _translations(
          ...
          descriptionPt:
              'Solte ombros tensos com círculos lentos e controlados.',
          instructionsEn:
  ...
  static Map<String, ActivityTranslation> _translations({
    required String titleEn,
    required String titlePt,
    required String descriptionEn,
    required String descriptionPt,
    required String instructionsEn,
    required String instructionsPt,
  }) {
    return <String, ActivityTranslation>{
